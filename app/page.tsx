  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(0,184,217,0.28),_transparent_42%),radial-gradient(circle_at_90%_10%,_rgba(34,211,238,0.14),_transparent_36%),radial-gradient(circle_at_70%_85%,_rgba(6,182,212,0.12),_transparent_38%),radial-gradient(circle_at_24%_78%,_rgba(168,85,247,0.16),_transparent_42%),radial-gradient(circle_at_82%_72%,_rgba(74,222,128,0.14),_transparent_40%),linear-gradient(180deg,#06090f_0%,#05070d_100%)] px-6 pt-10 pb-24 md:px-12 md:pb-10 lg:px-16">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col gap-8">
        <div className="flex flex-wrap items-center justify-between gap-1 rounded-2xl border border-cyan-300/20 bg-[rgba(5,12,30,0.88)] px-5 py-4 shadow-[0_0_0_1px_rgba(0,238,255,0.04),0_20px_50px_rgba(0,0,0,0.35)] backdrop-blur">
      ...
      <div className="absolute bottom-4 left-0 right-0 z-10 px-6 text-center md:px-12 lg:px-16">
        <p className="text-sm text-muted-foreground">
          Not affiliated with TensorWave. Data is from the AlphaVantage API and may be delayed.
        </p>
      </div>
    </main>
  );
